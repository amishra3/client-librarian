...
public class ClientLibraries {
    ...
    public static ClientLibrary forResource(Resource clientLibraryResource) {
        ...
        return new DefaultClientLibrary(clientLibraryCategories, clientLibraryResource, clientLibraryEmbeds, clientLibraryDependencies, slingRunModeGroupSet);

    }

    public static ClientLibrary newDefaultClientLibrary(Set<String> categories, Resource clientLibraryResource, List<String> embeddedCategories, List<String> dependencies, Set<SlingRunModeGroup> slingRunModeGroups) {

        return new DefaultClientLibrary(categories, clientLibraryResource, embeddedCategories, dependencies, slingRunModeGroups);
