...
/*
 * START CUSTOMIZATION
 * pmichelotti - Sep 2, 2013
 *
 * Since this is not running via the shell it is not accurately
 * detecting that Rhino is the environment.  Since I know that I'm
 * running in Rhino, I'm extracting that piece out.
 */
/*
 ...
 * START CUSTOMIZATION
 *
 * Since we are not in the scripting environment we don't have
 * arguments.  In lieu of the line commented out below I am passing
 * an empty array to the enclosed function
 */
//}(arguments));
//}([]));
} );
